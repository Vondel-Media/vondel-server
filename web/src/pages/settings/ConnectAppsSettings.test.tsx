...
describe("ConnectAppsSettings", () => {
  ...
  it("shows the plain account name and the Vondel origin on the Vondel tab", async () => {
    render();

    await click(findButton(container, "Vondel app or website"));

    expect(container.textContent).toContain("For Vondel's own apps");
