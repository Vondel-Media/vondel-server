  ...
  return (
    <>
      <SettingRow
        ...
        description="The resolution your profile should request when playback begins. Auto lets Vondel pick based on your connection."
        control={(id) => (
          <Select
            value={resolution}
            disabled={isSaving}
      ...
      <SettingRow
        ...
        description="Cap how much bandwidth playback may use. No limit means Vondel picks for the chosen resolution."
        control={(id) => (
          <Select
    ...
    <div className="space-y-6">
      <div className="space-y-4">
        <div className="space-y-3">
          ...
          <p className="text-muted-foreground max-w-2xl text-sm leading-relaxed">
            Choose the defaults Vondel should use when playback starts.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <SettingRow
          ...
          description="Jump past intros automatically when Vondel can detect them."
          control={(id) => (
            <Switch
              id={id}
        ...
        <SettingRow
          ...
          description="Skip 'previously on…' recaps automatically when Vondel can detect them."
          control={(id) => (
            <Switch
              id={id}
