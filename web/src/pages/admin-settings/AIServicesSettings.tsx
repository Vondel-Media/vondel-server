...
const TRANSCRIPTION_PRESETS = [
  {
    ...
    label: "Self-hosted",
    description:
      "Speaches or faster-whisper on your network. Replace the hostname with one reachable from the Vondel container.",
      ...
      <div className="divide-border border-border divide-y border-y">
        ...
        <section className="space-y-5 py-6">
          <SectionHeading
            ...
            description="A Whisper-compatible transcription endpoint that returns segment timestamps. Only required when Vondel generates subtitles from audio."
            status={
              !speechCompatible
          ...
          <div className="ml-0 space-y-3 sm:ml-11">
            ...
            <p className="text-muted-foreground max-w-2xl text-xs leading-relaxed">
              For self-hosted services, use a hostname or IP reachable from the Vondel container.
              <code className="mx-1">localhost</code>
              points back to Vondel itself.
            </p>
            <ConnectionCheckAction
        ...
        <section className="space-y-5 py-6">
          <div>
            ...
            <p className="text-muted-foreground mt-1 text-xs leading-relaxed">
              ...
              through Vondel&apos;s normal pipelines.
            </p>
          </div>
