...
function RegisterRelayRow({
  ...
  const renewalStatus = expirationValid
    ? expiration.getTime() <= Date.now()
      ? "Expired; Vondel will renew before the next delivery when the relay grace period permits."
      : `Expires ${expiration.toLocaleString()}; Vondel renews automatically during the final week with per-server jitter.`
    : configured
  ...
  return (
    <div className="space-y-3 py-3">
      <SettingField
        label="Deployment ID"
        hint="Opaque relay account for this Vondel server; created during registration"
        type="text"
        value={deploymentID}
        onChange={() => {}}
        disabled
  ...
  return (
    <div className="space-y-2 py-3">
      ...
      <div className="text-muted-foreground space-y-2 text-xs leading-relaxed">
        ...
        <p>
          Push notifications are generic; the app fetches private content directly from your Vondel
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex-1 space-y-7">
        ...
        <section className="space-y-3">
          ...
          <ChannelCard
            icon={RadioTower}
            title="Vondel Push Relay"
            description="Content-free mobile wakeups through Vondel's relay, delivered by APNs or FCM."
          ...
          >
            <div className="divide-border divide-y">
              ...
              <SettingField
                label="Relay URL"
                hint="Public relay endpoint used by this Vondel server; stored when you register"
                type="text"
                value={pushRelayURL}
          ...
          >
            <div className="divide-border divide-y">
              ...
              <SettingField
                ...
                hint="Request posts to Discord destinations @mention the requesting user when their account has linked Discord (in user notification settings). Unlinked accounts show their Vondel username without a mention."
                type="toggle"
