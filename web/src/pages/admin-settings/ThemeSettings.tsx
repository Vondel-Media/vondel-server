    ...
    if (settings && !seededRef.current) {
      ...
      setCatalogUrl(
        settings["theme.catalog_url"] ??
          "https://raw.githubusercontent.com/Vondel-Server/silo-themes/main/catalog.json",
      );
    }
  }, [settings]);
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <input
          ...
          placeholder="https://raw.githubusercontent.com/Vondel-Server/silo-themes/main/catalog.json"
        />
      </div>
    </div>
  );
