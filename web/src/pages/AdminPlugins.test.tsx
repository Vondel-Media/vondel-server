...
function makeCatalogEntry(
  ...
  const repoURL = `https://github.com/Vondel-Server/plugin-${suffix}`;
  return {
    repository_id: 1,
    ...
    source_kind: "silo",
    repository_name: "Vondel plugins",
    repo_url: repoURL,
    presentation: {
      ...
      publisher_name: "Vondel",
      publisher_url: "https://github.com/Vondel-Server",
...
function makeInstallation(index: number, displayName: string): PluginInstallation {
  ...
  return {
    ...
    presentation: {
      ...
      homepage_url: "",
      source_url: `https://github.com/Vondel-Server/installed-${suffix}`,
      support_url: "",
      changelog_url: "",
      publisher_name: "Vondel",
      publisher_url: "https://github.com/Vondel-Server",
...
describe("AdminPlugins", () => {
  ...
  it("shows catalog presentation metadata and external resource links", () => {
      ...
      catalog: [
        {
          ...
          source_kind: "silo",
          repository_name: "Vondel plugins",
          repo_url: "https://github.com/Vondel-Server/example-plugin",
          presentation: {
            ...
            source_url: "https://github.com/Vondel-Server/example-plugin",
            support_url: "https://github.com/Vondel-Server/example-plugin/issues",
            changelog_url: "https://github.com/Vondel-Server/example-plugin/releases",
            publisher_name: "Vondel",
            publisher_url: "https://github.com/Vondel-Server",
            license_spdx: "AGPL-3.0-or-later",
          },
    ...
    expect(markup).toContain('href="https://github.com/Vondel-Server/example-plugin"');
    expect(markup).toContain('href="https://github.com/Vondel-Server/example-plugin/releases"');
  });
