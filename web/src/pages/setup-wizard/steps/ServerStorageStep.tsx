  ...
  return (
    <div className="space-y-1.5">
      ...
      <p className="text-muted-foreground/70 text-xs">
        Optional. Stores all Vondel objects under this folder inside the bucket. Leave blank to use
        the bucket root.
      </p>
    </div>
  );
...
export function ServerStorageStep() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <div className="border-foreground/[0.06] bg-background/40 rounded-lg border px-3 py-3">
            ...
            <p className="text-muted-foreground mt-1 text-xs leading-relaxed">
              Lets Jellyfin-compatible apps discover Vondel, sign in, browse libraries, fetch
              metadata, and start playback through Vondel's compatibility API.
            </p>
          </div>
          <div className="border-foreground/[0.06] bg-background/40 rounded-lg border px-3 py-3">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                placeholder="Use Vondel managed directory"
              />
              <p className="text-muted-foreground/70 text-xs">
      ...
      >
        <p className="text-muted-foreground/80 text-xs leading-relaxed">
          Stores non-public Vondel objects such as imports, exports, and internal artifacts.
        </p>
        <div className="grid gap-3 sm:grid-cols-2">
          <div className="space-y-1.5">
            <Label className="text-xs">Endpoint</Label>
