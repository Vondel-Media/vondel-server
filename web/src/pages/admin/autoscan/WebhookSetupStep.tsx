  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground text-xs">
          Leave every other trigger unchecked — Vondel ignores them.
        </p>
      </div>

      <p className="text-muted-foreground text-xs">
        Save the connection in your download manager. You can use its
        <span className="font-medium"> Test </span> button — Vondel accepts test payloads and will
 ...
 * therefore pre-filled from real Vondel library paths and the operator supplies
