...
/**
 * Every Vondel-native path this source can produce: rewrite targets first (they
 ...
 *   already equals the Vondel path, so "correctly configured" and "no rewrites"
 *   are the same state);
 * - an `emits_native_paths` source returns Vondel paths directly.
 *
