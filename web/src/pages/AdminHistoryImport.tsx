            ...
            <div className="space-y-3">
              <p className="text-muted-foreground text-sm">
                {isPlex
                  ...
                  : "This key is used to discover users on the server and import their watch history into Vondel."}
              </p>
              <div className="space-y-1.5">
              ...
              {mappingTarget && (
                <div className="surface-panel-subtle space-y-4 rounded-xl border-0 p-4">
                  <p className="text-sm font-medium">
                    Map <span className="text-primary">{mappingTarget.name}</span> to a Vondel user
                    and profile:
                  </p>
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1.5">
                      <Label className="text-xs">Vondel user</Label>
                      <Select
                        value={userId}
                        onValueChange={(v) => {
                          setUserId(v);
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>Vondel user</TableHead>
      ...
      <div className="page-header">
        <div className="space-y-3">
          ...
          <p className="page-subtitle text-sm sm:text-base">
            Import watch history from external servers into Vondel user profiles.
          </p>
        </div>
      </div>
