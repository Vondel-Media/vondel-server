...
export const SETTING_DEFINITIONS: Record<SettingKey, SettingDefinition> = {
  "catalog.metadata_language": {
    ...
    description: "Fallback language Vondel prefers for titles, descriptions, and artwork.",
    category: "catalog",
    control: "select",
  ...
  "playback.audio_language": {
    ...
    description: "Choose which spoken language Vondel should prefer first.",
    category: "playback",
    control: "select",
  ...
  "playback.max_bitrate_kbps": {
    ...
    description:
      "Cap how much bandwidth playback may use. No cap means Vondel picks for the chosen resolution.",
    category: "playback",
    control: "select",
    unit: "kbps",
    minimum: 100,
  ...
  "playback.preferred_quality": {
    ...
    description: "Pick the quality Vondel should prefer.",
    category: "playback",
    control: "select",
    values: [
  ...
  "playback.subtitle_language": {
    ...
    description: "Choose which subtitle language Vondel should prefer first.",
    category: "playback",
    control: "select",
  ...
  "playback.subtitle_mode": {
    ...
    defaultValue: "auto",
    label: "Subtitles",
    description: "When Vondel should turn subtitles on.",
    category: "playback",
    control: "select",
    values: [
      { value: "auto", label: "Auto", introducedIn: 1 },
  ...
  "player.passout_threshold": {
    ...
    description:
      "How many episodes auto-play before Vondel asks whether you are still watching. 0 never asks.",
    category: "player",
    control: "stepper",
    unit: "episodes",
  ...
  "subtitle.matches_device": {
    ...
    description: "Use the operating system's caption style instead of Vondel's.",
    category: "playback",
    control: "switch",
    platforms: ["ios", "tvos", "macos", "android", "android_tv"],
  },
  ...
  "ui.theme": {
    ...
    label: "Theme",
    description: "Colour theme for the Vondel interface.",
    category: "appearance",
    control: "select",
    platforms: ["web"],
    values: [
