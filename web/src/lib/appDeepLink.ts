/**
 * Deep links into the native Vondel apps via the silo:// custom scheme.
 *
 * Vondel is self-hosted, so the store apps cannot pre-verify every server's
...
/** Detects a platform with a native Vondel app from the user agent. */
