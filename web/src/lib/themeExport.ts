...
export interface VondelThemeFile {
  version: 1;
  name: string;
  description?: string;
  author?: string;
...
export function parseThemeFile(json: unknown): VondelThemeFile {
...
export function downloadTheme(theme: VondelThemeFile): void {
...
export async function readThemeFile(file: File): Promise<VondelThemeFile> {
