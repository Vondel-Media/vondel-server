  ...
  switch (terminal.reason) {
    ...
    case "source_metadata_incomplete":
      return {
        ...
        message:
          "Vondel doesn't know enough about this file yet to plan playback. Try again once the scan finishes.",
      };
    ...
    case "no_alternate_version":
      return {
        ...
        message:
          "Vondel couldn't find a way to play this file on this device. Try another version if one is available.",
      };
    ...
    case "audio_conversion_unsupported":
      return {
        ...
        message: "Vondel can't convert this file into something this device can play.",
      };
    ...
    case "subtitle_artifact_unavailable":
      return {
        ...
        message:
          "Vondel couldn't prepare the selected subtitles for this device. Try a different track.",
      };
    default:
      return {
        title: "Playback unavailable",
        message: terminal.message?.trim() || "Vondel could not start playback.",
      };
  }
}
...
export function describePlaybackTransportError(
  ...
  if (error.status >= 500) {
    return {
      title: "Playback unavailable",
      message: "Vondel could not start playback right now. Please try again.",
    };
  }
