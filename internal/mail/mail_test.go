...
func TestLoadConfigValidation(t *testing.T) {
	...
	t.Run("defaults", func(t *testing.T) {
		...
		if cfg.port != 587 || cfg.security != securityStartTLS || cfg.fromName != "Vondel" {
...
func TestBuildMessageMultipart(t *testing.T) {
	cfg := &smtpConfig{fromAddress: "silo@example.com", fromName: "Vondel"}
	...
	for _, want := range []string{"multipart/alternative", "plain", "rich", "Vondel", "user@example.com"} {
